...
class Idioma extends DataObject
{
    ...
    {
        $conn = parent::connect();
        $sql = "SELECT * FROM " . TABLE_IDIOMA . " WHERE idIdioma = :id";
        try {
            $st = $conn->prepare($sql);
    ...
    {
        $conn = parent::connect();
        $sql = "INSERT INTO Idioma (idIdioma,nombreIdioma)
     VALUES (:idIdioma,:nombreIdioma)";
        ...
        header("Location: http://localhost/BICICLETES/public/contenido-idioma.php");
        die();
    }
