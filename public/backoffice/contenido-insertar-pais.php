...
<script>
	$(document).ready(function () {
		...
		$("#tablita").on("click",".boton-insertar",function(){
			$("#tablita>.row:nth-of-type(2)").after('<hr>\
				<div class="row"> \
				<form action="CRUD-pais.php" method="post" class="form-inline col-sm-12"> \
				<div class="col-sm-3 form-group"> \
				<input type="text" class="form-control col-sm-12" name="idInsert" id="id" placeholder="id de País" disabled> \
				</div> \
				<div class="col-sm-3 form-group"> \
				<input type="text" class="form-control col-sm-12" name="nombreInsert" id="nombre" placeholder="Nombre de País"  > \
				</div> \
				<div class="col-sm-3 form-group"> \
	...
	<div id="tablita"  class="col-sm-12">
		<h1 class="text-left pt-1 mt-1 pb-5">Países</h1>
		<div class="row">
		...
		<hr>
		<?php $formes = Pais::selectAll();
		foreach ($formes as $value) {
			foreach ($value as $test) { ?>
			<div class="row">
				<form action="CRUD-pais.php" method="post" class="form-inline col-sm-12">
					<div class="col-sm-3 form-group">
						<p class="hidden-sm"></p><input type="text" class="form-control col-sm-12" name="id" id="id" placeholder="id de País" value='<?php echo $test->getValueEncoded("idPais"); ?>' disabled>
					</div>
					<div class="col-sm-3 form-group">
						<input type="text" class="form-control col-sm-12 unlock" name="nombre" id="nombre" placeholder="Nombre de País" value='<?php echo $test->getValueEncoded("nombrePais"); ?>' disabled>
					</div>
					<div class="col-sm-3 form-group">
